...
>注意：本项目没有使用任何代理，API 在前端发送请求，能否连通基于你当前浏览器的所处的网络环境。如果你需要在服务端发送 API 请求的 ChatGPT，可以查看另一个项目 [chatgpt-nuxt](https://github.com/lianginx/chatgpt-nuxt)，点击这里 [在线体验](http://ai.in-x.cc/)。

vue使用nuxt，react使用next，做改动时候注意保证chatApi已获取，本项目是桌面端，迁移时候注意！！！！

变更为小程序最好使用微信开发者工具制作，不要使用uniapp！！！
...
二次封装后，需要考虑公司的用户习惯，服务器渲染ssr要及时更新！！！
